...
if (age < 18 ) {
    newcpk = cpk*0.80;
    discount = "Complimenti, essendo minorenne hai diritto ad uno sconto del 20% sul prezzo del biglietto;"
    savedprice = cpk*0.20;
    ...
    newcpk = cpk*0.60;
    discount = "Complimenti, essendo over 65 hai diritto ad uno sconto del 40% sul prezzo del biglietto;"
    savedprice = cpk*0.40;
    savedprice = savedprice.toFixed(2) + '€'
    cpk = cpk + '€'
